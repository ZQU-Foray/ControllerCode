...
void HAL_OSPI_MspInit(OSPI_HandleTypeDef* ospiHandle)
{
  ...
  */
    ...
    */
    GPIO_InitStruct.Pin = W25Q64_HOLD_OSPI_IO3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF9_OCTOSPIM_P1;
    HAL_GPIO_Init(W25Q64_HOLD_OSPI_IO3_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = W25Q64_WP_OSPI_IO2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF6_OCTOSPIM_P1;
    HAL_GPIO_Init(W25Q64_WP_OSPI_IO2_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = W25Q64_SO_OSPI_IO1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF4_OCTOSPIM_P1;
    HAL_GPIO_Init(W25Q64_SO_OSPI_IO1_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = W25Q64_CLK_OSPI_CLK_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF9_OCTOSPIM_P1;
    HAL_GPIO_Init(W25Q64_CLK_OSPI_CLK_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = W25Q64_CS_OSPI_NCS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF11_OCTOSPIM_P1;
    HAL_GPIO_Init(W25Q64_CS_OSPI_NCS_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = W25Q64_SI_OSPI_IO0_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF9_OCTOSPIM_P1;
    HAL_GPIO_Init(W25Q64_SI_OSPI_IO0_GPIO_Port, &GPIO_InitStruct);
...
void HAL_OSPI_MspDeInit(OSPI_HandleTypeDef* ospiHandle)
{
  ...
  /* USER CODE END OCTOSPI2_MspDeInit 0 */
    ...
    PD11     ------> OCTOSPIM_P1_IO0
    */
    HAL_GPIO_DeInit(GPIOA, W25Q64_HOLD_OSPI_IO3_Pin|W25Q64_WP_OSPI_IO2_Pin);

    HAL_GPIO_DeInit(GPIOB, W25Q64_SO_OSPI_IO1_Pin|W25Q64_CLK_OSPI_CLK_Pin);

    HAL_GPIO_DeInit(W25Q64_CS_OSPI_NCS_GPIO_Port, W25Q64_CS_OSPI_NCS_Pin);

    HAL_GPIO_DeInit(W25Q64_SI_OSPI_IO0_GPIO_Port, W25Q64_SI_OSPI_IO0_Pin);
